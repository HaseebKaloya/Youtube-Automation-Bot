...
class YouTubeAutomationGUI(ctk.CTk):
    def __init__(self):
        ...
        self.title("🔰 KaloyaXploit - YouTube Automation Suite")
    ...
    def create_status_bar(self):
        ...
        self.status_label = ctk.CTkLabel(
            status_frame, 
            text="🔰 KaloyaXploit - Ready | Think Secure. Act Smart."
        )
    ...
    def update_status(self, message):
        """Update status bar"""
        self.status_label.configure(text=f"🔰 KaloyaXploit - {message}")
...
class SettingsDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        self.title("⚙️ Settings - KaloyaXploit")
...
def main():
    ...
    try:
        ...
        app.log_message("🔰 KaloyaXploit YouTube Automation Suite Started", "success")
        app.log_message("💡 Think Secure. Act Smart.", "info")
